...
f_exact_city_postings <- function(p_city_filter,p_df,p_colour = "red"){
  ...
  mapshot(exact_map, url = paste("/cloud/project/R_Notebook/Final/Data/MapFiles/",p_city_filter,"map.html",sep="_"))
...
f_acled_merge <- function(p_city_filter,p_df,p_eps,p_k,p_outlier_remove = TRUE,p_acled_year = FALSE,p_acled_city = TRUE){
  ...
  mapshot(f_acled_map, url = paste("/cloud/project/R_Notebook/Final/Data/MapFiles/",p_city_filter,"ACLED_map.html",sep="_"))
...
### 5.0 Test different cities {#h_4.2_analysis}
[Back to index](#h_0.2_index)

In this section, different cities are examined for qualitative assessment in the final assessment.
#### 5.1 CAIRO
```{r}
###CAIRO
